...
%
function [new_img, new_M] = WFK_affine(handles,old_img, old_M, new_elem_size, verbose, bg, method)
   ...
   %
   set(handles.TotalCountText,'String',sprintf('%d',new_dim(3)));
   pause on;
   pause(0.005);
   for z = 1:new_dim(3)
      set(handles.CurrentText,'String',sprintf('%d',z));
      pause(0.001);
%        
%       if verbose & ~mod(z,10)
