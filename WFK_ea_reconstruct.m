function [coords,trajvector,trajectory,tramat]=WFK_ea_reconstruct(patientname,options,side)
...
for refine=0:options.refinesteps
    [trajectory,trajvector]=WFK_ea_reconstruct_trajectory(trajectory,tra_nii,side,refine,options);
end
