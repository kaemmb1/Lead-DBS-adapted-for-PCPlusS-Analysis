...
%
function WFK_ea_reslice_nii(handles,old_fn, new_fn, voxel_size, verbose, bg, method, img_idx, preferredForm)
...
%          end
         ...
         [img(:,:,:,i) M] = ...
		WFK_affine(handles,nii.img(:,:,:,i), old_M, voxel_size, verbose, bg, method);
      end
   else
      [img M] = WFK_affine(handles,nii.img, old_M, voxel_size, verbose, bg, method);
   end
